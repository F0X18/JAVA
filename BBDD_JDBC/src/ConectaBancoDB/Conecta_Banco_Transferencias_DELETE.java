...
public class Conecta_Banco_Transferencias_DELETE {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String eliminacionSQL= "DELETE FROM transferencias where id='2'";
			//paso 4 inserto la eliminacion de transferencia
