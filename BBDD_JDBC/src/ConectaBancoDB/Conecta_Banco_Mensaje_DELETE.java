...
public class Conecta_Banco_Mensaje_DELETE {
	...
	public static void main(String[] args) {
		...
		try {
			...
			//paso 3 genero los datos a eliminar de mensaje
			String eliminacionSQL= "DELETE FROM mensaje where id='2'";
			//paso 4 inserto la eliminacion de mensaje
